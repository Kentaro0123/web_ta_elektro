            ...
            <table class="table print-container"   >
                <thead>
                    <tr class="filters ">
                        ...
                        <th><input type="text" class="form-control" placeholder="Tgl sidang Akhir" disabled></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($user->riwayat_mahasiswa->first()->skripsi ?? 0)
                                @if ($user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->dosen_sidang_akhir ?? 0)

                                    @foreach ($user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->dosen_sidang_akhir as $item)
                                        {{ $item->user->nama }} <hr>
                                    @endforeach
                        ...
                        <td>
                            @if ( !isset($user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->jam_pelaksanaan) )
                            X
                            @else
                                    {{ $user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->hari_pelaksanaan }}
                                    <br>
                                    {{ $user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->jam_pelaksanaan }}-
                                    {{ $user->riwayat_mahasiswa->first()->skripsi->jadwal_sidang_akhir->jam_selesai}}
