...
<script>
  ...
  $(document).ready(function() {
      ...
      // Fungsi untuk menambahkan judul nilai <updated>
    function tambahJudulNilai(judulNilai, bobotNilai) {
      var totalBobot = hitungTotalBobot() + parseInt(bobotNilai);
      if (totalBobot > 100) {
        alert('Total bobot melebihi 100. Tidak dapat menambahkan judul nilai.');
      ...
      judulNilaiCount++;
      var judulNilaiId = 'judul-nilai-' + judulNilaiCount;
      var judulSubNilaiCount = 0; // Menghitung jumlah sub judul nilai dalam judul nilai ini
      ...
      // Fungsi untuk menambahkan judul sub nilai <updated>
    function tambahJudulSubNilai(judulNilaiId, judulSubNilai) {
      var judulSubNilaiContainer = $('div[data-judul-nilai-id="' + judulNilaiId + '"]');
      var judulSubNilaiCount = judulSubNilaiContainer.children().length;
...
{{-- <script>
    $(document).ready(function() {
    var judulNilaiCount = 0; // menghitung jumlah judul nilai
    var judulSubNilaiCounts = {}; // menyimpan jumlah judul sub nilai untuk setiap judul nilai
    ...
    function tambahJudulNilai(judulNilai, bobotNilai) {
      ...
      judulNilaiCount++;
      judulSubNilaiCounts[judulNilaiCount] = 0; // inisialisasi jumlah judul sub nilai untuk judul nilai baru
    ...
    function tambahJudulSubNilai(judulNilaiId, judulSubNilai) {
      var judulSubNilaiContainer = $('div[data-judul-nilai-id="' + judulNilaiId + '"]');
      var judulSubNilaiCount = judulSubNilaiCounts[judulNilaiId] + 1;
      judulSubNilaiCounts[judulNilaiId]++; // update jumlah judul sub nilai untuk judul nilai tersebut

      var html = '<div class="judul-sub-nilai">' +
        '<input type="text" name="judul_sub_nilai[' + judulNilaiId + '][' + judulSubNilaiCount + ']" value="' + judulSubNilai + '">' +
        '<a href="#" class="btn btn-danger hapus-sub-judul" data-judul-sub-nilai-id="' + judulNilaiId + '-' + judulSubNilaiCount + '">Hapus</a>' +
        '</div>';
